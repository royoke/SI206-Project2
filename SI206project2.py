...
def find_urls(s):
    url_list = re.findall('http[s]?://\S+[.]+\S+', s) #using reg ex to only look at parts of string s that are in a url format
    return url_list
...
def grab_headlines():
    ...
    return headlines #returns the list of headlines
